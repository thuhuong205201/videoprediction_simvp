...
def create_parser():
    ...
    parser.add_argument('--data_root', default='/content/drive/MyDrive/Deep_learning/Final/dataKTH/')
    parser.add_argument('--dataname', default='kth', choices=['mmnist', 'taxibj', 'kth'])
    parser.add_argument('--num_workers', default=8, type=int)

    # model parameters
    parser.add_argument('--in_shape', default=[10, 1, 128, 128], type=int,nargs='*') # [10, 1, 64, 64] for mmnist, [4, 2, 32, 32] for taxibj , [10, 1, 128, 128] 
